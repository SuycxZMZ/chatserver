...
void doRegResponse(json &response_js)
{
    ...
    {
        // 注册失败
        cerr << "your name is invalid register error!!!" << endl;
    }
    else
    {
        // 注册成功
        cout << "register success, and userid : " << response_js["id"] << " ,please rember it!!!" << endl;
    }
}
